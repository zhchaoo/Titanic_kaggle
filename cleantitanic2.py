...
def phase2clean(train, test):
    ...
    for df in [train, test]:
        ...
        df.Fare = df[['Fare', 'Pclass']].apply(lambda x: classmeans.loc[x['Pclass']] if pd.isnull(x['Fare']) else x['Fare'], axis=1)
    ...
    data_type_dict['AgeXClass']='numeric'
...
def clean(traindf, testdf, no_bins=0):
...
if __name__ == "__main__":
    ...
    [traindf, testdf, type_dict] = clean(traindf, testdf)
    pass
